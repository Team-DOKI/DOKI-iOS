...
enum WalkScene: AppScene {
    ...
    case sharedWalkCompletion(distance: Double, elapsedTime: String, stepCount: Int, routeId: Int, routeImageUrl: String?)
    ...
    func build() -> some View {
        ...
        case .sharedWalkCompletion(let distance, let elapsedTime, let stepCount, let routeId, let routeImageUrl):
