...
struct WalkPreparationView: View {
    @StateObject var viewModel: WalkPreparationViewModel
    
    @State private var items: [WalkPreparationData] = []
                ...
                HStack(spacing: 8) {
                    ...
                    TextField("준비물을 작성해주세요", text: $newItemText)
                        ...
                        .onSubmit {
                            ...
                            items.append(
                                WalkPreparationData(name: trimmed, isChecked: false)
                            )
                            newItemText = ""
                            isAddingItem = false
                        }
