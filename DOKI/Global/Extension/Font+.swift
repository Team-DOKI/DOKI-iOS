...
extension Font {
    ...
    static let header3 = Font.pretendard(size: 20, weight: .semibold)
    ...
    static let bodyActive = Font.pretendard(size: 14, weight: .medium)
    static let bodySmall = Font.pretendard(size: 12, weight: .regular)
    ...
    static let small = Font.pretendard(size: 10, weight: .medium)
